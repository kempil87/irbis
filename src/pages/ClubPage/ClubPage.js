                        ...
                        <Col className="mb-5">
                            <Tab.Content>
                                <Tab.Pane eventKey="first">
                                    ...
                                    <div className="d-flex  flex-wrap ">
                                        {goalkepper.map((i, index) => (
                                            <Link to={`/club${i._id}`} className="d-flex col-12 col-lg-3 justify-content-center" key={i.id}>
                                ...
                                <Tab.Pane eventKey="second">
                                    <div className="d-flex flex-wrap">
                                        {coach.map((i, index) => (
                                            <Link to={`/club${i._id}`} className="d-flex col-12 col-lg-3 justify-content-center" key={i._id}>
                                                <div className=" top-info-allPlayer">
                                                    <img className="player-img" src={i.image} alt="//"/>
                                                    {/*<img className="player-img-main" src={i.mainImage} alt="//"/>*/}
                                                    <div className="player-name mb-2">{i.name}</div>
