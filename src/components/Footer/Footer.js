        ...
        <>
            <div className="footer">
                    <div className="footer-wrap d-flex ">
                        <div className="footer-left d-flex align-items-center flex-column flex-lg-row col-lg-4">
                        ...
                        <div  className="footer-mid d-flex mt-5">
                        ...
                        <div className="footer-right d-flex col-12 col-lg-4 justify-content-center">
