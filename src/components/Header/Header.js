                ...
                <div className="header-wrap">
                    ...
                    <div className="header-navbar">
                        ...
                        <div className="header-content d-none d-sm-flex">
                            ...
                            <NavLink to="/news" className={({isActive}) => isActive ? "header-alink" : "header-link"}>Новости</NavLink>
                            <NavLink to="/championship" className={({isActive}) => isActive ? "header-alink" : "header-link"}>Чемпионат</NavLink>
